...
tipo boolean, #1 salgada, 2 doce
tipo_massa varchar(50),
primary key(id)
);

insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Grande',true,'Fina');
insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Grande',true,'Grossa');
insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Média',true,'Fina');
insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Média',true,'Grossa');
insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Pequena',true,'Fina');
insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Pequena',true,'Grossa');
insert into tb_categoria (tamanho,tipo,tipo_massa) values ('Pequena',false,'Fina');
